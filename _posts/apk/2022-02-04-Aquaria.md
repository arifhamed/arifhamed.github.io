...
title: "Aquaria"
layout: post-apk
package: com.bit_blot.aquaria_humble_1.1.apk
...
<div class="text-center">
    <a class="btn btn-dark btn-block w-100" onclick='apk("{{ page.package }}")' style="text-decoration: none; background-color: #333;"> Download <b>{{ page.package }}</b> (515 MB)</a>
</div>
