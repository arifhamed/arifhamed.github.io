...
<span ondblclick="document.getElementById('paid').style.display='inline'">Now, there are quite a number of reviews for both the free and paid versions of this game, apparently there almost no difference between the two versions. Either way, unless you double click this text, i have only uploaded the free version, because as said by quite a lot of reviewers, both have ads, which is just horrible imo.</span>
...
<div class="text-center">
    ...
    <a id="paid" class="btn btn-dark btn-block w-100" onclick='apk("com.clapfootgames.laserwars_1.1.2.apk")' target="_blank" style="text-decoration: none; background-color: #333; display: none;"> Download <b>com.clapfootgames.laserwars_1.1.2.apk</b> (23.5 MB)</a>
</div>
