...
<span ondblclick="document.getElementById('paid').style.display='inline'">This game does not need my words, either the community or its own self speaks for itself</span>
...
<div class="text-center">
    ...
    <a id="paid" class="btn btn-dark btn-block w-100" onclick='apk("com.fastemulator.gbc_1.5.1.apk")' target="_blank" style="text-decoration: none; background-color: #333; display: none;"> Download <b>com.fastemulator.gbc_1.5.1.apk</b> (417 KB)</a>
</div>
